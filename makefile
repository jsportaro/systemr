...
systemr: arena.c main.c catalog.c binder.c sql.c parser.c sql.c parser.gen.c lexer.gen.c
	gcc $(CFLAGS) -o systemr arena.c main.c  catalog.c binder.c sql.c parser.c parser.gen.c lexer.gen.c
